...
echo 'Le fruit à la 3ème position dans le tableau est : '.$fruits[2] ."<br>";

//----------------------------------------

echo 'Remplacer des valeurs du tableau. Pomme devient Mangue, Cerise devient Letchis et Banane devient Fruit de la Passion'."<br>";
